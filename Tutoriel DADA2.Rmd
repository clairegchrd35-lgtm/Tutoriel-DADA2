...
Ce tutoriel présente la version 1.16 du pipeline DADA2, depuis les fichiers FASTQ démultiplexés jusqu\'à la construction de tables ASV, l\'attribution de taxonomie et l\'importation dans phyloseq pour analyse.
...
Les lectures forward sont de bonne qualité.

Il est recommandé de tronquer les derniers nucléotides pour éviter les erreurs, mais ces profils ne nécessitent pas de suppression supplémentaire.
